 ...
 * @author Daniel Lucas
 */
public class FormAgendamentoMelhoria extends javax.swing.JFrame {

    ConexaoBd conBd = new ConexaoBd();
    BeansAgendamentoMelhoria agenda = new BeansAgendamentoMelhoria();
    ...
    //String dtHoje;
    // String status;]
    /* passeias variáfeis para private */
     ...
     */
    public FormAgendamentoMelhoria() {
        initComponents();
...
////                        + "AGENDAMENTO.DTAGENDAMENTO IS NULL";
      public void preencherHorario() {
        ...
        try {
            String sql = "SELECT IDHORA,HORA FROM HORARIO "
                    + "LEFT JOIN AGENDAMENTO ON HORARIO.IDHORA = AGENDAMENTO.IDHORA "
                        + "AND AGENDAMENTO.DTAGENDAMENTO = ('"+ jDateChooserAgendamento.getDateFormatString()+ "') "
                        + "AND AGENDAMENTO.IDMEDICO = '" + idMedico + "' WHERE "
                        + "AGENDAMENTO.DTAGENDAMENTO IS NULL";
    ...
    private void initComponents() {
        ...
        jTextFieldIdRetorno = new javax.swing.JTextField();
        ...
        jTextFieldIdRetorno.setEnabled(false);
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addComponent(jButtonEmail, javax.swing.GroupLayout.PREFERRED_SIZE, 57, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(jPanel1Layout.createSequentialGroup()
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(jTextFieldIdRetorno, javax.swing.GroupLayout.PREFERRED_SIZE, 67, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(jLabel8)
                    .addComponent(jTextFieldIdRetorno, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jButtonBuscarConsulta))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jLabel5)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void jComboBoxRetornoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBoxRetornoActionPerformed
        ...
        if (jComboBoxRetorno.getSelectedItem().equals("Sim")) {
            jTextFieldIdRetorno.setEnabled(true);
    ...
    private void jButtonEmailActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonEmailActionPerformed
        ...
        String msg = jTextFieldPaciente.getText()
                ...
                + dt.format(jDateChooserAgendamento.getDate()) + ", proximo ao dia \n"
                + "da consulta será encaminhado um email de confirmação, solicitamos para que o mesmo seja respondido "
                + "e caso exista uma desistência, gentileza nos informe com um prazo de 24h.\n\n"
    ...
    private void jButtonConcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonConcluirActionPerformed
        ...
        agenda.setIdHora(jComboBoxHorario.getSelectedIndex());
        System.out.println(" idhora" + jComboBoxHorario.getSelectedIndex());
        agenda.setMotivo(jTextAreaMotivo.getText());
        agenda.setData(jDateChooserAgendamento.getDateFormatString());
        System.out.println(""+jDateChooserAgendamento.getDateFormatString());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormAgendamentoMelhoria.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormAgendamentoMelhoria().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTextField jTextFieldIdRetorno;
