...
public class FormTesteEnvioEmail extends javax.swing.JFrame {
    ...
    Integer porta;
    boolean ssl = true;
    String hostname, senha, email;
    String subject = "Email teste.";
    String msg = "Prezado, tenha um bom dia!\n\n"
...
*/
     ...
     * @param senha
     */
    public FormTesteEnvioEmail(String email, String hostname, Integer porta, String senha) {
        initComponents();
        jLabelEmail.setText(email);//escrevendo no label o email principal para o envio
        this.email = email;
        this.porta = porta;//salva o valor da portado smtp
        //this.ssl = ssl;
        this.senha = senha;//salva na variável senha a senha 
        this.hostname = hostname;// salva na variavel qual e o servidr de email
    }
