 ...
 * @author Daniel Lucas
 */
public class FormTabs extends javax.swing.JFrame {

    /**
     * Creates new form FormTabs
     */
    public FormTabs() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormTabs.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
