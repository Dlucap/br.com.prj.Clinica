...
public class FormTesteEnvioEmail extends javax.swing.JFrame {
    ...
    /**
     * trecho do cod para alterar icone do java na janela da aplicação URL url =
     * this.getClass().getResource("imagem.png"); Image imagemTitulo =
...
//@SuppressWarnings("unchecked")
    ...
    private void initComponents() {
        ...
        jLabelBarraProgresso = new javax.swing.JLabel();
        ...
        jProgressBar.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED));
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jLabelBarraProgresso, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jLabelBarraProgresso, javax.swing.GroupLayout.PREFERRED_SIZE, 28, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        setSize(new java.awt.Dimension(335, 247));
    ...
    private void jToggleButtonTesteEnvioEmailActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jToggleButtonTesteEnvioEmailActionPerformed
         ...
         /**
         * @hostname @portas @emails @senhaEmail
         */
                    ...
                    for (int i = 0; i < 101; i++) {
                        try {
                            ...
                            if (jProgressBar.getValue() <= 25) {
                                jLabelBarraProgresso.setText("Iniciando a barra de progresso  0 < 25 %");
                            } else if (jProgressBar.getValue() <= 50) {
                                jLabelBarraProgresso.setText("Barra de progresso em 25 < 50 %");
                            } else if (jProgressBar.getValue() <= 75) {
                                jLabelBarraProgresso.setText("Barra de progresso em 50 < 75 ");
                            } else {
                                jLabelBarraProgresso.setText("Finalizado 100%");
                            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormTesteEnvioEmail.class
    ...
    private javax.swing.JLabel jLabelBarraProgresso;
