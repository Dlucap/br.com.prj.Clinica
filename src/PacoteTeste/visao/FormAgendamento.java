...
public class FormAgendamento extends javax.swing.JFrame {
    ...
    public FormAgendamento() {
        ...
        preencherTabelaAgendamento("SELECT IDPACIENTE,NOMEPACIENTE,TELRESIDENCIAL, TELCELULAR,CENOME,"
                + "CETELRESIDENCIAL,CETELCELULAR FROM PACIENTE ");
    }
    ...
    public FormAgendamento(String agenda) {
        ...
        String sql = "SELECT AGENDAMENTO.IDAGENDAMENTO, STATUSCONSULTA, ESPECIALIDADE.ESPEC, PACIENTE.NOMEPACIENTE, "
                + "MEDICO.NOMEMEDICO, HORARIO.IDHORA, DTAGENDAMENTO, IDAGENDAMENTO, HORARIO.HORA  FROM AGENDAMENTO "
    ...
    private void initComponents() {
        ...
        jDateChooserAgendamento.addVetoableChangeListener(new java.beans.VetoableChangeListener() {
            public void vetoableChange(java.beans.PropertyChangeEvent evt)throws java.beans.PropertyVetoException {
                jDateChooserAgendamentoVetoableChange(evt);
            }
        });
...
//          }            
    ...
    private void jTableAgendamentoConsultaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTableAgendamentoConsultaMouseClicked
        ...
        String sql = "SELECT NOMEPACIENTE FROM PACIENTE WHERE NOMEPACIENTE = '" + Nome + "'";
    ...
    private void jButtonConcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonConcluirActionPerformed
        ...
        String data = String.valueOf(jDateChooserAgendamento.getDate());

        DaoAgendamento dao = new DaoAgendamento();

        int hora = dao.BuscarIDHora((String) jComboBoxHorario.getSelectedItem());
    ...
    private void jButtonBuscarPacienteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonBuscarPacienteActionPerformed
        ...
        preencherTabelaAgendamento("SELECT IDPACIENTE,NOMEPACIENTE,TELRESIDENCIAL, TELCELULAR,CENOME,CETELRESIDENCIAL,CETELCELULAR "
                + "FROM PACIENTE WHERE NOMEPACIENTE like '%" + jTextFieldPaciente.getText() + "%'");
            ...
            if (daoCheckDate.EhFimDeSemana(calendar)) {
                try {
                    JOptionPane.showMessageDialog(rootPane, "A data selecionada (" + format.format(jDateChooserAgendamento.getDate()) + " - "
                            + daoCheckDate.checaFDS(format.format(jDateChooserAgendamento.getDate())) + ") encontra-se em um fim de semana.\n "
    ...
    private void jDateChooserAgendamentoVetoableChange(java.beans.PropertyChangeEvent evt)throws java.beans.PropertyVetoException {//GEN-FIRST:event_jDateChooserAgendamentoVetoableChange
        System.out.println("PacoteTeste.visao.FormAgendamento.jDateChooserAgendamentoVetoableChange()");
        // TODO add your handling code here:
    }//GEN-LAST:event_jDateChooserAgendamentoVetoableChange
...
//        conBd.DesconectarBd();
    ...
    public void preencherTabelaAgendamento(String sql) {
        ...
        String[] colunas = new String[]{"ID", "NOME DO PACIENTE", "TEL.RESIDENCIAL",
            "TEL.CELULAR", "ACOMPANHANTE", "TEL ACOMPANHANTE", "CEL ACOMPANHANTE"};
